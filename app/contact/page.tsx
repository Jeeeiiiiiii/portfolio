  ...
  return (
    <div className="py-12 md:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex space-x-4">
                ...
                >
                  ...
                  <path d="M22.675 0h-21.35C.595 0 0 .594 0 1.326v21.348C0 23.406.595 24 1.326 
                    24H12.82v-9.294H9.692v-3.622h3.127V8.413c0-3.1 1.894-4.788 4.659-4.788 
                    1.325 0 2.463.099 2.794.143v3.24h-1.918c-1.504 0-1.796.716-1.796 
                    1.765v2.313h3.587l-.467 3.622h-3.12V24h6.116c.73 0 
                    1.324-.594 1.324-1.326V1.326C24 .594 23.405 0 22.675 0z"/>
                  </svg>
                </a>
                <a
       ...
       {/* Replace the Map Image section with this */}
  <div className="mt-16">
